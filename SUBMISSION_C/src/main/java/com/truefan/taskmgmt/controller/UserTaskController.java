...
public class UserTaskController {
    ...
    public ResponseDto createTask(@RequestBody TaskDto taskDto, @PathVariable("userId") Long userId) {
        ResponseDto responseDto = new ResponseDto();
    ...
    public ResponseDto getCreatedTasks(@PathVariable("userId") Long userId) {
        ResponseDto responseDto = new ResponseDto();
        responseDto.setOperation(OperationType.CREATE_TASK.getType());
    ...
    public ResponseDto createTask(@PathVariable("taskId") Long taskId, @PathVariable("userId") Long userId) {
        ResponseDto responseDto = new ResponseDto();
    ...
    public ResponseDto getAssignedTasks(@PathVariable("userId") Long userId) {
        ...
        try {
            ...
            responseDto.setOutput("Error while getting assigned tasks : " + ex.getMessage());
        }
        return responseDto;
    }
